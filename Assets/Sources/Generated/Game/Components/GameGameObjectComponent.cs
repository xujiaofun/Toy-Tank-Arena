...
public partial class GameEntity {
    ...
    public void AddGameObject(UnityEngine.GameObject newValue, UnityEngine.Transform newTransform) {
    ...
    public void ReplaceGameObject(UnityEngine.GameObject newValue, UnityEngine.Transform newTransform) {
        var index = GameComponentsLookup.GameObject;
        var component = CreateComponent<GameObjectComponent>(index);
        component.value = newValue;
        component.transform = newTransform;
